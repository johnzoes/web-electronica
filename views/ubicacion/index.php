        ...
        <tbody>
            <?php foreach ($ubicaciones as $ubicacion): ?>
                <tr>
                    ...
                    <?php if ($rol != 3): // Si no es profesor ?>
                        <td>
                            <a href="index.php?controller=ubicacion&action=edit&id=<?php echo htmlspecialchars($ubicacion['id_ubicacion'], ENT_QUOTES, 'UTF-8'); ?>"
                                class="btn btn-primary ">
                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50 " width="20px"
                                    height="20px">
                                    <path
                            ...
                            <a href="index.php?controller=ubicacion&action=delete&id=<?php echo htmlspecialchars($ubicacion['id_ubicacion'], ENT_QUOTES, 'UTF-8'); ?>"
