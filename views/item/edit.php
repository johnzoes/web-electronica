...
<div class="container">
    <h2>Editar Item</h2>
    <form
        action="index.php?controller=item&action=update&id=<?php echo htmlspecialchars($item['id_item'], ENT_QUOTES, 'UTF-8'); ?>"
        method="POST" enctype="multipart/form-data">
        <div class="form-group">
            <label for="codigo_bci">Código BCI:</label>
            <input type="text" class="form-control" id="codigo_bci" name="codigo_bci"
                value="<?php echo htmlspecialchars($item['codigo_bci'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
        <div class="form-group">
            <label for="descripcion">Descripción:</label>
            <textarea class="form-control" id="descripcion" name="descripcion" rows="3"
                required><?php echo htmlspecialchars($item['descripcion'], ENT_QUOTES, 'UTF-8'); ?></textarea>
        </div>
        <div class="form-group">
            <label for="cantidad">Cantidad:</label>
            <input type="number" class="form-control" id="cantidad" name="cantidad"
                value="<?php echo htmlspecialchars($item['cantidad'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
        <div class="form-group">
            <label for="estado">Estado:</label>
            <input type="text" class="form-control" id="estado" name="estado"
                value="<?php echo htmlspecialchars($item['estado'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
        <div class="form-group">
            <label for="marca">Marca:</label>
            <input type="text" class="form-control" id="marca" name="marca"
                value="<?php echo htmlspecialchars($item['marca'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
        <div class="form-group">
            <label for="modelo">Modelo:</label>
            <input type="text" class="form-control" id="modelo" name="modelo"
                value="<?php echo htmlspecialchars($item['modelo'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
        <div class="mb-3">
            <label for="imagen" class="form-label">Imagen</label>
            <input type="file" class="form-control" id="imagen" name="imagen">
            <input type="hidden" name="imagen_actual"
                value="<?php echo htmlspecialchars($item['imagen'], ENT_QUOTES, 'UTF-8'); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nro_inventariado" name="nro_inventariado"
                value="<?php echo htmlspecialchars($item['nro_inventariado'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
